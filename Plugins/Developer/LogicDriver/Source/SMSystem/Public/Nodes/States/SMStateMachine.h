...
public:
	 ...
	 * @param bForwardToReference If this is a state machine reference the function will execute there.
	 */
	TArray<FSMNode_Base*> GetAllNodes(bool bIncludeNested = false, bool bForwardToReference = false) const;
	 ...
	 * @param InScopedToStates States to limit the scope of processing. If empty the Active states are used.
	 */
