...
#define SIZE_STATE_EXPECTED 512
#define SIZE_CONDUIT_EXPECTED 512
#define SIZE_TRANSITION_EXPECTED 536
#define SIZE_STATE_MACHINE_EXPECTED 840

#define SIZE_GRAPH_PROPERTY_EXPECTED 72

#else // Linux values

#define SIZE_STATE_EXPECTED 512-8
#define SIZE_CONDUIT_EXPECTED 512-8
#define SIZE_TRANSITION_EXPECTED 536
#define SIZE_STATE_MACHINE_EXPECTED 840-8
