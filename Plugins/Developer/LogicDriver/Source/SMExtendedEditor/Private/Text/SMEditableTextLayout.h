...
private:
	...
	{
	public:
		static TSharedRef<FVirtualKeyboardEntry> Create(FSMEditableTextLayout& InOwnerLayout);
	...
	private:
		FVirtualKeyboardEntry(FSMEditableTextLayout& InOwnerLayout);
		FSMEditableTextLayout* OwnerLayout;
	};
...
private:
	...
	{
	public:
		static TSharedRef<FTextInputMethodContext> Create(FSMEditableTextLayout& InOwnerLayout);
	...
	private:
		FTextInputMethodContext(FSMEditableTextLayout& InOwnerLayout);
		FSMEditableTextLayout* OwnerLayout;
