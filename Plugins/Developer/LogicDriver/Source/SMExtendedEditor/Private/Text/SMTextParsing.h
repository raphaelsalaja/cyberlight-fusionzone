...
public:
	...
	static FParserResults ConvertToRichText(const FText& InText, UBlueprint* InBlueprint, TMap<FName, FGuid>* ExistingVariables = nullptr, TMap<FName, FGuid>* ExistingFunctions = nullptr);
