...
{
public:
	explicit FScopedEditableTextTransaction(FSMEditableTextLayout& InEditableTextLayout)
...
private:
	FSMEditableTextLayout* EditableTextLayout;
};
...
FSMEditableTextLayout::FSMEditableTextLayout(ISlateEditableTextWidget& InOwnerWidget,
	const TAttribute<FText>& InInitialText, FTextBlockStyle InTextStyle,
	const TOptional<ETextShapingMethod> InTextShapingMethod, const TOptional<ETextFlowDirection> InTextFlowDirection,
	const FCreateSlateTextLayout& InCreateSlateTextLayout, TSharedRef<ITextLayoutMarshaller> InTextMarshaller,
	TSharedRef<ITextLayoutMarshaller> InHintTextMarshaller)
{
	...
	UICommandList->MapAction(FGenericCommands::Get().Undo,
		FExecuteAction::CreateRaw(this, &FSMEditableTextLayout::Undo),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecuteUndo),
		EUIActionRepeatMode::RepeatEnabled
	);

	UICommandList->MapAction(FGenericCommands::Get().Cut,
		FExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CutSelectedTextToClipboard),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecuteCut)
	);

	UICommandList->MapAction(FGenericCommands::Get().Paste,
		FExecuteAction::CreateRaw(this, &FSMEditableTextLayout::PasteTextFromClipboard),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecutePaste),
		EUIActionRepeatMode::RepeatEnabled
	);

	UICommandList->MapAction(FGenericCommands::Get().Copy,
		FExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CopySelectedTextToClipboard),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecuteCopy)
	);

	UICommandList->MapAction(FGenericCommands::Get().Delete,
		FExecuteAction::CreateLambda(ExecuteDeleteAction),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecuteDelete)
	);

	UICommandList->MapAction(FGenericCommands::Get().SelectAll,
		FExecuteAction::CreateRaw(this, &FSMEditableTextLayout::SelectAllText),
		FCanExecuteAction::CreateRaw(this, &FSMEditableTextLayout::CanExecuteSelectAll)
	);
}

FSMEditableTextLayout::~FSMEditableTextLayout()
{
...
void FSMEditableTextLayout::SetText(const TAttribute<FText>& InText)
{
...
FText FSMEditableTextLayout::GetText() const
{
	return BoundText.Get(FText::GetEmpty());
}

void FSMEditableTextLayout::SetHintText(const TAttribute<FText>& InHintText)
{
	HintText = InHintText;
...
FText FSMEditableTextLayout::GetHintText() const
{
	return HintText.Get(FText::GetEmpty());
}

void FSMEditableTextLayout::SetSearchText(const TAttribute<FText>& InSearchText)
{
...
FText FSMEditableTextLayout::GetSearchText() const
{
	return SearchText;
}

void FSMEditableTextLayout::SetTextStyle(const FTextBlockStyle& InTextStyle)
{
	TextStyle = InTextStyle;
...
const FTextBlockStyle& FSMEditableTextLayout::GetTextStyle() const
{
	return TextStyle;
}

void FSMEditableTextLayout::SetCursorBrush(const TAttribute<const FSlateBrush*>& InCursorBrush)
{
	CursorLineHighlighter->SetCursorBrush(InCursorBrush);
}

void FSMEditableTextLayout::SetCompositionBrush(const TAttribute<const FSlateBrush*>& InCompositionBrush)
{
	TextCompositionHighlighter->SetCompositionBrush(InCompositionBrush);
}

FText FSMEditableTextLayout::GetPlainText() const
{
...
bool FSMEditableTextLayout::SetEditableText(const FText& TextToSet, const bool bForce)
{
...
FText FSMEditableTextLayout::GetEditableText() const
{
	FString EditedText;
...
FText FSMEditableTextLayout::GetSelectedText() const
{
	if (AnyTextSelected())
	{
...
void FSMEditableTextLayout::SetTextShapingMethod(const TOptional<ETextShapingMethod>& InTextShapingMethod)
{
	TextLayout->SetTextShapingMethod((InTextShapingMethod.IsSet()) ? InTextShapingMethod.GetValue() : GetDefaultTextShapingMethod());
}

void FSMEditableTextLayout::SetTextFlowDirection(const TOptional<ETextFlowDirection>& InTextFlowDirection)
{
	TextLayout->SetTextFlowDirection((InTextFlowDirection.IsSet()) ? InTextFlowDirection.GetValue() : GetDefaultTextFlowDirection());
}

void FSMEditableTextLayout::SetTextWrapping(const TAttribute<float>& InWrapTextAt, const TAttribute<bool>& InAutoWrapText, const TAttribute<ETextWrappingPolicy>& InWrappingPolicy)
{
...
void FSMEditableTextLayout::SetWrapTextAt(const TAttribute<float>& InWrapTextAt)
{
	WrapTextAt = InWrapTextAt;
...
void FSMEditableTextLayout::SetAutoWrapText(const TAttribute<bool>& InAutoWrapText)
{
	AutoWrapText = InAutoWrapText;
...
void FSMEditableTextLayout::SetWrappingPolicy(const TAttribute<ETextWrappingPolicy>& InWrappingPolicy)
{
	WrappingPolicy = InWrappingPolicy;
...
void FSMEditableTextLayout::SetMargin(const TAttribute<FMargin>& InMargin)
{
	Margin = InMargin;
...
void FSMEditableTextLayout::SetJustification(const TAttribute<ETextJustify::Type>& InJustification)
{
...
void FSMEditableTextLayout::SetLineHeightPercentage(const TAttribute<float>& InLineHeightPercentage)
{
...
void FSMEditableTextLayout::SetDebugSourceInfo(const TAttribute<FString>& InDebugSourceInfo)
{
...
TSharedRef<IVirtualKeyboardEntry> FSMEditableTextLayout::GetVirtualKeyboardEntry() const
{
	return VirtualKeyboardEntry.ToSharedRef();
}

TSharedRef<ITextInputMethodContext> FSMEditableTextLayout::GetTextInputMethodContext() const
{
	return TextInputMethodContext.ToSharedRef();
}

bool FSMEditableTextLayout::Refresh()
{
	const FText& TextToSet = BoundText.Get(FText::GetEmpty());
	return RefreshImpl(&TextToSet);
}

bool FSMEditableTextLayout::RefreshImpl(const FText* InTextToSet, const bool bForce)
{
...
void FSMEditableTextLayout::ForceRefreshTextLayout(const FText& CurrentText)
{
...
void FSMEditableTextLayout::BeginSearch(const FText& InSearchText, const ESearchCase::Type InSearchCase, const bool InReverse)
{
...
void FSMEditableTextLayout::AdvanceSearch(const bool InReverse)
{
...
FVector2D FSMEditableTextLayout::SetHorizontalScrollFraction(const float InScrollOffsetFraction)
{
	ScrollOffset.X = FMath::Clamp<float>(InScrollOffsetFraction, 0.0, 1.0) * TextLayout->GetSize().X;
	return ScrollOffset;
}

FVector2D FSMEditableTextLayout::SetVerticalScrollFraction(const float InScrollOffsetFraction)
{
	ScrollOffset.Y = FMath::Clamp<float>(InScrollOffsetFraction, 0.0, 1.0) * TextLayout->GetSize().Y;
	return ScrollOffset;
}

FVector2D FSMEditableTextLayout::SetScrollOffset(const FVector2D& InScrollOffset, const FGeometry& InGeometry)
{
...
FVector2D FSMEditableTextLayout::GetScrollOffset() const
{
	return ScrollOffset;
}

bool FSMEditableTextLayout::HandleFocusReceived(const FFocusEvent& InFocusEvent)
{
	if (ActiveContextMenu.IsValid())
	{
		return false;
...
bool FSMEditableTextLayout::HandleFocusLost(const FFocusEvent& InFocusEvent)
{
	if (ActiveContextMenu.IsValid())
	{
		return false;
...
FReply FSMEditableTextLayout::HandleKeyChar(const FCharacterEvent& InCharacterEvent)
{
...
FReply FSMEditableTextLayout::HandleKeyDown(const FKeyEvent& InKeyEvent)
{
...
FReply FSMEditableTextLayout::HandleKeyUp(const FKeyEvent& InKeyEvent)
{
...
FReply FSMEditableTextLayout::HandleMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& InMouseEvent)
{
	FReply Reply = FReply::Unhandled();
...
FReply FSMEditableTextLayout::HandleMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& InMouseEvent)
{
	FReply Reply = FReply::Unhandled();
		...
		else if (InMouseEvent.GetEffectingButton() == EKeys::RightMouseButton)
		{
			if (MyGeometry.IsUnderLocation(InMouseEvent.GetScreenSpacePosition()))
			{
				...
				if (MenuContentWidget.IsValid())
				{
					...
					{
						ContextMenu->GetOnMenuDismissed().AddRaw(this, &FSMEditableTextLayout::OnContextMenuClosed);
...
FReply FSMEditableTextLayout::HandleMouseMove(const FGeometry& InMyGeometry, const FPointerEvent& InMouseEvent)
{
...
FReply FSMEditableTextLayout::HandleMouseButtonDoubleClick(const FGeometry& InMyGeometry, const FPointerEvent& InMouseEvent)
{
	if (InMouseEvent.GetEffectingButton() == EKeys::LeftMouseButton)
	{
...
bool FSMEditableTextLayout::HandleEscape()
{
	if (!SearchText.IsEmpty())
	{
		// Clear search
...
bool FSMEditableTextLayout::HandleBackspace()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FSMEditableTextLayout::HandleDelete()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FSMEditableTextLayout::HandleTypeChar(const TCHAR InChar)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FSMEditableTextLayout::HandleCarriageReturn()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FSMEditableTextLayout::CanExecuteDelete() const
{
...
void FSMEditableTextLayout::DeleteSelectedText()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
bool FSMEditableTextLayout::AnyTextSelected() const
{
	const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
...
bool FSMEditableTextLayout::IsTextSelectedAt(const FGeometry& MyGeometry, const FVector2D& ScreenSpacePosition) const
{
...
bool FSMEditableTextLayout::IsTextSelectedAt(const FVector2D& InLocalPosition) const
{
	const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
	const FTextLocation SelectionPosition = SelectionStart.Get(CursorInteractionPosition);
...
bool FSMEditableTextLayout::CanExecuteSelectAll() const
{
	bool bCanExecute = true;
...
void FSMEditableTextLayout::SelectAllText()
{
	if (TextLayout->IsEmpty())
	{
		return;
...
void FSMEditableTextLayout::SelectWordAt(const FGeometry& MyGeometry, const FVector2D& ScreenSpacePosition)
{
	const FVector2D LocalPosition = MyGeometry.AbsoluteToLocal(ScreenSpacePosition);
	SelectWordAt(LocalPosition * MyGeometry.Scale);
}

void FSMEditableTextLayout::SelectWordAt(const FVector2D& InLocalPosition)
{
...
void FSMEditableTextLayout::ClearSelection()
{
	SelectionStart = TOptional<FTextLocation>();
}

bool FSMEditableTextLayout::CanExecuteCut() const
{
	bool bCanExecute = true;
...
void FSMEditableTextLayout::CutSelectedTextToClipboard()
{
...
bool FSMEditableTextLayout::CanExecuteCopy() const
{
	bool bCanExecute = true;
...
void FSMEditableTextLayout::CopySelectedTextToClipboard()
{
	if (OwnerWidget->IsTextPassword())
	{
		return;
...
bool FSMEditableTextLayout::CanExecutePaste() const
{
	bool bCanExecute = true;
...
void FSMEditableTextLayout::PasteTextFromClipboard()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
void FSMEditableTextLayout::InsertTextAtCursor(const FString& InString)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
void FSMEditableTextLayout::InsertTextAtCursorImpl(const FString& InString)
{
...
void FSMEditableTextLayout::InsertNewLineAtCursorImpl()
{
...
TSharedRef<IRun> FSMEditableTextLayout::CreateTextOrPasswordRun(const FRunInfo& InRunInfo, const TSharedRef<const FString>& InText, const FTextBlockStyle& InStyle)
{
	if (OwnerWidget->IsTextPassword())
	{
...
void FSMEditableTextLayout::OnContextMenuClosed(TSharedRef<IMenu> Menu)
{
...
void FSMEditableTextLayout::InsertRunAtCursor(TSharedRef<IRun> InRun)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
bool FSMEditableTextLayout::MoveCursor(const FMoveCursor& InArgs)
{
...
void FSMEditableTextLayout::GoTo(const FTextLocation& NewLocation)
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
void FSMEditableTextLayout::GoTo(ETextLocation NewLocation)
{
	JumpTo(NewLocation, ECursorAction::MoveCursor);
}

void FSMEditableTextLayout::JumpTo(ETextLocation JumpLocation, ECursorAction Action)
{
...
void FSMEditableTextLayout::ScrollTo(const FTextLocation& NewLocation)
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	if (Lines.IsValidIndex(NewLocation.GetLineIndex()))
	{
...
void FSMEditableTextLayout::UpdateCursorHighlight()
{
	...
	else if (bHasSelection)
	{
		...
		else
		{
			...
			for (int32 LineIndex = SelectionBeginningLineIndex; LineIndex <= SelectionEndLineIndex; ++LineIndex)
			{
				...
				else if (LineIndex >= 0 && LineIndex < Lines.Num()) // Check necessary to fix undo crash [replace text with a letter, then undo]
				{
	...
	{
		if (TextLayout->GetLineModels().IsValidIndex(LineHighlight.LineIndex)) // Check necessary to fix undo crash [replace text with a letter, then undo]
		{
...
void FSMEditableTextLayout::RemoveCursorHighlight()
{
	const TArray<FTextLayout::FLineModel>& Lines = TextLayout->GetLineModels();
...
void FSMEditableTextLayout::UpdatePreferredCursorScreenOffsetInLine()
{
...
void FSMEditableTextLayout::ApplyToSelection(const FRunInfo& InRunInfo, const FTextBlockStyle& InStyle)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
TSharedPtr<const IRun> FSMEditableTextLayout::GetRunUnderCursor() const
{
	const TArray<FTextLayout::FLineModel>& Lines = TextLayout->GetLineModels();
...
TArray<TSharedRef<const IRun>> FSMEditableTextLayout::GetSelectedRuns() const
{
...
FTextLocation FSMEditableTextLayout::TranslatedLocation(const FTextLocation& Location, int8 Direction) const
{
	check(Direction != 0);
...
void FSMEditableTextLayout::TranslateLocationVertical(const FTextLocation& Location, int32 NumLinesToMove, float GeometryScale, FTextLocation& OutCursorPosition, TOptional<SlateEditableTextTypes::ECursorAlignment>& OutCursorAlignment) const
{
	const TArray< FTextLayout::FLineView >& LineViews = TextLayout->GetLineViews();
...
FTextLocation FSMEditableTextLayout::ScanForWordBoundary(const FTextLocation& CurrentLocation, int8 Direction) const
{
...
TCHAR FSMEditableTextLayout::GetCharacterAt(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
bool FSMEditableTextLayout::IsAtBeginningOfDocument(const FTextLocation& Location) const
{
	return Location.GetLineIndex() == 0 && Location.GetOffset() == 0;
}

bool FSMEditableTextLayout::IsAtEndOfDocument(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	const int32 NumberOfLines = Lines.Num();
...
bool FSMEditableTextLayout::IsAtBeginningOfLine(const FTextLocation& Location) const
{
	return Location.GetOffset() == 0;
}

bool FSMEditableTextLayout::IsAtEndOfLine(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	return Lines[Location.GetLineIndex()].Text->Len() == Location.GetOffset();
}

bool FSMEditableTextLayout::IsAtWordStart(const FTextLocation& Location) const
{
...
void FSMEditableTextLayout::RestoreOriginalText()
{
...
bool FSMEditableTextLayout::HasTextChangedFromOriginal() const
{
...
void FSMEditableTextLayout::BeginEditTransation()
{
...
void FSMEditableTextLayout::EndEditTransaction()
{
	if (!StateBeforeChangingText.IsSet())
	{
...
void FSMEditableTextLayout::PushUndoState(const SlateEditableTextTypes::FUndoState& InUndoState)
{
...
void FSMEditableTextLayout::ClearUndoStates()
{
	CurrentUndoLevel = INDEX_NONE;
	UndoStates.Empty();
}

void FSMEditableTextLayout::MakeUndoState(SlateEditableTextTypes::FUndoState& OutUndoState)
{
...
void FSMEditableTextLayout::SaveText(const FText& TextToSave)
{
...
void FSMEditableTextLayout::LoadText()
{
...
bool FSMEditableTextLayout::ComputeVolatility() const
{
...
void FSMEditableTextLayout::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
	...
	const float FontMaxCharHeight = FSMTextEditHelper::GetFontHeight(TextStyle.Font);
	const float CaretWidth = FSMTextEditHelper::CalculateCaretWidth(FontMaxCharHeight);
...
int32 FSMEditableTextLayout::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled)
{
...
void FSMEditableTextLayout::CacheDesiredSize(float LayoutScaleMultiplier)
{
	const float FontMaxCharHeight = FSMTextEditHelper::GetFontHeight(TextStyle.Font);
	const float CaretWidth = FSMTextEditHelper::CalculateCaretWidth(FontMaxCharHeight);
...
FVector2D FSMEditableTextLayout::ComputeDesiredSize(float LayoutScaleMultiplier) const
{
	const float FontMaxCharHeight = FSMTextEditHelper::GetFontHeight(TextStyle.Font);
	const float CaretWidth = FSMTextEditHelper::CalculateCaretWidth(FontMaxCharHeight);
...
FChildren* FSMEditableTextLayout::GetChildren()
{
...
void FSMEditableTextLayout::OnArrangeChildren(const FGeometry& AllottedGeometry, FArrangedChildren& ArrangedChildren) const
{
...
FVector2D FSMEditableTextLayout::GetSize() const
{
	return TextLayout->GetSize();
}

TSharedRef<SWidget> FSMEditableTextLayout::BuildDefaultContextMenu(const TSharedPtr<FExtender>& InMenuExtender) const
{
...
bool FSMEditableTextLayout::HasActiveContextMenu() const
{
	return ActiveContextMenu.IsValid();
}


TSharedRef<FSMEditableTextLayout::FVirtualKeyboardEntry> FSMEditableTextLayout::FVirtualKeyboardEntry::Create(FSMEditableTextLayout& InOwnerLayout)
{
	return MakeShareable(new FVirtualKeyboardEntry(InOwnerLayout));
}

FSMEditableTextLayout::FVirtualKeyboardEntry::FVirtualKeyboardEntry(FSMEditableTextLayout& InOwnerLayout)
	: OwnerLayout(&InOwnerLayout)
{
}

void FSMEditableTextLayout::FVirtualKeyboardEntry::SetTextFromVirtualKeyboard(const FText& InNewText, ETextEntryType TextEntryType)
{
...
void FSMEditableTextLayout::FVirtualKeyboardEntry::SetSelectionFromVirtualKeyboard(int InSelStart, int InSelEnd)
{
...
FText FSMEditableTextLayout::FVirtualKeyboardEntry::GetHintText() const
{
	return OwnerLayout->GetHintText();
}

EKeyboardType FSMEditableTextLayout::FVirtualKeyboardEntry::GetVirtualKeyboardType() const
{
	return (OwnerLayout->OwnerWidget->IsTextPassword()) ? Keyboard_Password : OwnerLayout->OwnerWidget->GetVirtualKeyboardType();
}

FVirtualKeyboardOptions FSMEditableTextLayout::FVirtualKeyboardEntry::GetVirtualKeyboardOptions() const
{
	return OwnerLayout->OwnerWidget->GetVirtualKeyboardOptions();
}

bool FSMEditableTextLayout::FVirtualKeyboardEntry::IsMultilineEntry() const
{
	return OwnerLayout->OwnerWidget->IsMultiLineTextEdit();
}


TSharedRef<FSMEditableTextLayout::FTextInputMethodContext> FSMEditableTextLayout::FTextInputMethodContext::Create(FSMEditableTextLayout& InOwnerLayout)
{
	return MakeShareable(new FTextInputMethodContext(InOwnerLayout));
}

FSMEditableTextLayout::FTextInputMethodContext::FTextInputMethodContext(FSMEditableTextLayout& InOwnerLayout)
	: OwnerLayout(&InOwnerLayout)
	, bIsComposing(false)
...
bool FSMEditableTextLayout::FTextInputMethodContext::IsComposing()
{
	return OwnerLayout && bIsComposing;
}

bool FSMEditableTextLayout::FTextInputMethodContext::IsReadOnly()
{
	return !OwnerLayout || OwnerLayout->OwnerWidget->IsTextReadOnly();
}

uint32 FSMEditableTextLayout::FTextInputMethodContext::GetTextLength()
{
	if (!OwnerLayout)
	{
		return 0;
...
void FSMEditableTextLayout::FTextInputMethodContext::GetSelectionRange(uint32& BeginIndex, uint32& Length, ECaretPosition& OutCaretPosition)
{
	if (!OwnerLayout)
	{
		BeginIndex = 0;
...
void FSMEditableTextLayout::FTextInputMethodContext::SetSelectionRange(const uint32 BeginIndex, const uint32 Length, const ECaretPosition InCaretPosition)
{
	if (!OwnerLayout)
	{
		return;
...
void FSMEditableTextLayout::FTextInputMethodContext::GetTextInRange(const uint32 BeginIndex, const uint32 Length, FString& OutString)
{
	if (!OwnerLayout)
	{
		OutString.Reset();
...
void FSMEditableTextLayout::FTextInputMethodContext::SetTextInRange(const uint32 BeginIndex, const uint32 Length, const FString& InString)
{
	if (!OwnerLayout)
	{
		return;
...
int32 FSMEditableTextLayout::FTextInputMethodContext::GetCharacterIndexFromPoint(const FVector2D& Point)
{
	if (!OwnerLayout)
	{
		return INDEX_NONE;
...
bool FSMEditableTextLayout::FTextInputMethodContext::GetTextBounds(const uint32 BeginIndex, const uint32 Length, FVector2D& Position, FVector2D& Size)
{
	if (!OwnerLayout)
	{
...
void FSMEditableTextLayout::FTextInputMethodContext::GetScreenBounds(FVector2D& Position, FVector2D& Size)
{
	if (!OwnerLayout)
	{
		Position = FVector2D::ZeroVector;
...
void FSMEditableTextLayout::FTextInputMethodContext::CacheWindow()
{
	if (!OwnerLayout)
	{
		return;
...
TSharedPtr<FGenericWindow> FSMEditableTextLayout::FTextInputMethodContext::GetWindow()
{
	if (!OwnerLayout)
	{
		return nullptr;
...
void FSMEditableTextLayout::FTextInputMethodContext::BeginComposition()
{
	if (!OwnerLayout)
	{
		return;
...
void FSMEditableTextLayout::FTextInputMethodContext::UpdateCompositionRange(const int32 InBeginIndex, const uint32 InLength)
{
	if (!OwnerLayout)
	{
		return;
...
void FSMEditableTextLayout::FTextInputMethodContext::EndComposition()
{
	if (!OwnerLayout)
	{
		return;
