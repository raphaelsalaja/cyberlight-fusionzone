...
class SSMEditableTextBlock : public SCompoundWidget
{
	...
	/** The default text if no other text is passied in. */
	...
	TSharedPtr< SSMEditableTextBox > GetRichTextBlock() const { return MultiLineTextBox; }
...
protected:
	...
	TSharedPtr< SSMEditableTextBox > MultiLineTextBox;
