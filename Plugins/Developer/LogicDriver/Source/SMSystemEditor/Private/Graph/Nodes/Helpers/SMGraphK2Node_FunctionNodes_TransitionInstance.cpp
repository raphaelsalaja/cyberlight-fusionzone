...
void USMGraphK2Node_TransitionStackInstance_CanEnterTransition::PreCompileValidate(FCompilerResultsLog& MessageLog)
{
	// Skip parent call as it calls GetNodeTemplateClass which won't work for this case.
	USMGraphK2Node_RuntimeNodeReference::PreCompileValidate(MessageLog);
