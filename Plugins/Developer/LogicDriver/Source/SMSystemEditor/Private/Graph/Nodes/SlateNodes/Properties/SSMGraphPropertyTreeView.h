...
struct FSMGraphPropertyTreeItem
{
	...
	USMGraphK2Node_PropertyNode_Base* PropertyNode;
	...
	bool IsCategory() const { return PropertyNode == nullptr ;}
	...
	{
		const FString NameString = PropertyNode != nullptr ? TreeId : CategoryName;
	...
	{
		return CategoryName == Other.CategoryName && PropertyNode == Other.PropertyNode;
	}
};
...
public:
	...
	void Construct(const FArguments& InArgs, const TSharedRef<SSMPropertyTreeView>& TreeView);
