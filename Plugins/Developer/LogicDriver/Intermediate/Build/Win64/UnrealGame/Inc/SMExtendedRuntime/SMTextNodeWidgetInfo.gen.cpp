...
template<> SMEXTENDEDRUNTIME_API UScriptStruct* StaticStruct<FSMTextNodeWidgetInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_SMSystem_Source_SMExtendedRuntime_Public_Properties_SMTextNodeWidgetInfo_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_SMSystem_Source_SMExtendedRuntime_Public_Properties_SMTextNodeWidgetInfo_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_SMSystem_Source_SMExtendedRuntime_Public_Properties_SMTextNodeWidgetInfo_h_531252883(TEXT("/Script/SMExtendedRuntime"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_SMSystem_Source_SMExtendedRuntime_Public_Properties_SMTextNodeWidgetInfo_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_SMSystem_Source_SMExtendedRuntime_Public_Properties_SMTextNodeWidgetInfo_h_Statics::ScriptStructInfo),
		nullptr, 0);
