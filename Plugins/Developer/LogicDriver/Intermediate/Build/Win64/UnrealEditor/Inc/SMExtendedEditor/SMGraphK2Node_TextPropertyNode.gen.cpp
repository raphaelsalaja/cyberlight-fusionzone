...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USMGraphK2Node_TextPropertyNode()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMGraphK2Node_TextPropertyNode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMGraphK2Node_TextPropertyNode, 803282002);
