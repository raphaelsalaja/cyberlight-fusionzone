...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USMPropertyGraphSchema()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMPropertyGraphSchema_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMPropertyGraphSchema, 2507688881);
	template<> SMSYSTEMEDITOR_API UClass* StaticClass<USMPropertyGraphSchema>()
	{
		return USMPropertyGraphSchema::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USMPropertyGraphSchema(Z_Construct_UClass_USMPropertyGraphSchema, &USMPropertyGraphSchema::StaticClass, TEXT("/Script/SMSystemEditor"), TEXT("USMPropertyGraphSchema"), false, nullptr, nullptr, nullptr);
