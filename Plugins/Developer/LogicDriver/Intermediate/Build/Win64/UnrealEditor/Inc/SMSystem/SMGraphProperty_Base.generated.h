...
#define Revenant5_Plugins_Developer_LogicDriver_Source_SMSystem_Public_Properties_SMGraphProperty_Base_h_89_GENERATED_BODY \
	...
	FORCEINLINE static uint32 __PPO__bHidden() { return STRUCT_OFFSET(FSMGraphProperty_Base, bHidden); } \
	FORCEINLINE static uint32 __PPO__GuidUnmodified() { return STRUCT_OFFSET(FSMGraphProperty_Base, GuidUnmodified); } \
	FORCEINLINE static uint32 __PPO__TemplateGuid() { return STRUCT_OFFSET(FSMGraphProperty_Base, TemplateGuid); } \
	FORCEINLINE static uint32 __PPO__GuidIndex() { return STRUCT_OFFSET(FSMGraphProperty_Base, GuidIndex); } \
...
#define Revenant5_Plugins_Developer_LogicDriver_Source_SMSystem_Public_Properties_SMGraphProperty_Base_h_20_GENERATED_BODY \
	...
	FORCEINLINE static uint32 __PPO__OwnerGuid() { return STRUCT_OFFSET(FSMGraphProperty_Base_Runtime, OwnerGuid); }
