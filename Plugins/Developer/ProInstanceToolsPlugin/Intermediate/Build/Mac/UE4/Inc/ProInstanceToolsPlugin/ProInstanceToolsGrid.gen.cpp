...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_NumInstances;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsGrid_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ProInstanceToolsGrid.h" },
		{ "ModuleRelativePath", "Private/ProInstanceToolsGrid.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_NumInstances_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_NumInstances = { "NumInstances", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsGrid, NumInstances), Z_Construct_UScriptStruct_FIntVector, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_NumInstances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_NumInstances_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_Spacing_MetaData[] = {
		{ "Category", "Pro Instance Grid" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_Spacing = { "Spacing", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsGrid, Spacing), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_Spacing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_Spacing_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProInstanceToolsGrid_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_NumInstances,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsGrid_Statics::NewProp_Spacing,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AProInstanceToolsGrid_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AProInstanceToolsGrid()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AProInstanceToolsGrid_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AProInstanceToolsGrid, 1068947613);
