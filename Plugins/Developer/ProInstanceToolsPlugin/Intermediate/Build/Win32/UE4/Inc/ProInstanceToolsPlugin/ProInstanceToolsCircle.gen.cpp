...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceToolsCircleInstanceRotationType_Hash() { return 2527966693U; }
...
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_RotationType;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsCircle_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ProInstanceToolsCircle.h" },
		{ "ModuleRelativePath", "Private/ProInstanceToolsCircle.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_NumInstances_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_NumInstances = { "NumInstances", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsCircle, NumInstances), METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_NumInstances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_NumInstances_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Angle_MetaData[] = {
		{ "Category", "Pro Instance Circle" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Angle = { "Angle", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsCircle, Angle), METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Angle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Angle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Radius_MetaData[] = {
		{ "Category", "Pro Instance Circle" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsCircle, Radius), METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_RotationType_MetaData[] = {
		{ "Category", "Pro Instance Circle" },
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_RotationType = { "RotationType", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsCircle, RotationType), Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceToolsCircleInstanceRotationType, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_RotationType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_RotationType_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProInstanceToolsCircle_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_NumInstances,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Angle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_Radius,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsCircle_Statics::NewProp_RotationType,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AProInstanceToolsCircle_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AProInstanceToolsCircle()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AProInstanceToolsCircle_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AProInstanceToolsCircle, 1385587449);
