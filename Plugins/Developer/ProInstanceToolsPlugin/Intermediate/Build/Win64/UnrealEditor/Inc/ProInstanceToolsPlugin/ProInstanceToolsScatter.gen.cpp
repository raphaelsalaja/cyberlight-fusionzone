...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceScatterBoxPivotPoint_Hash() { return 389549216U; }
	...
	uint32 Get_Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceScatterPlacementType_Hash() { return 186559240U; }
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BoxPivotPoint_MetaData[];
#endif
		static const UECodeGen_Private::FBytePropertyParams NewProp_BoxPivotPoint;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ProInstanceToolsScatter.h" },
		{ "ModuleRelativePath", "Private/ProInstanceToolsScatter.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_NumInstances_MetaData[] = {
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_NumInstances = { "NumInstances", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, NumInstances), METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_NumInstances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_NumInstances_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_PlacementType_MetaData[] = {
		{ "Category", "Pro Instance Scatter" },
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_PlacementType = { "PlacementType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, PlacementType), Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceScatterPlacementType, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_PlacementType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_PlacementType_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxSize_MetaData[] = {
		{ "Category", "Pro Instance Scatter" },
		{ "Comment", "/** Box Size. */" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxSize = { "BoxSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, BoxSize), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxSize_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxExtent_MetaData[] = {
		{ "Category", "Pro Instance Scatter" },
		{ "Comment", "/** Box Extent. */" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxExtent = { "BoxExtent", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, BoxExtent), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxExtent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxExtent_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxPivotPoint_MetaData[] = {
		{ "Category", "Pro Instance Scatter" },
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxPivotPoint = { "BoxPivotPoint", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, BoxPivotPoint), Z_Construct_UEnum_ProInstanceToolsPlugin_EProInstanceScatterBoxPivotPoint, METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxPivotPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxPivotPoint_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_SphereRadius_MetaData[] = {
		{ "Category", "Pro Instance Scatter" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_SphereRadius = { "SphereRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProInstanceToolsScatter, SphereRadius), METADATA_PARAMS(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_SphereRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_SphereRadius_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProInstanceToolsScatter_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_NumInstances,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_PlacementType,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxSize,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxExtent,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_BoxPivotPoint,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProInstanceToolsScatter_Statics::NewProp_SphereRadius,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AProInstanceToolsScatter_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AProInstanceToolsScatter()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AProInstanceToolsScatter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AProInstanceToolsScatter, 2500991338);
